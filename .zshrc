...
export ZSH="/home/asocha/.oh-my-zsh"
...
source "$HOME/.aliases-rh"
export WORKON_HOME="$HOME/.virtualenvs"
export PROJECT_HOME="$HOME/work/code"
source "$HOME/.local/bin/virtualenvwrapper.sh"
alias ki='echo "Authenticating in kerberos ... " && echo "$(cat ~/.ssh/kerberos.pass)" > kinit -f && echo "Done"'
...
#        tmux attach -t engine || tmux new -s engine; exit
#    fi
#fi
